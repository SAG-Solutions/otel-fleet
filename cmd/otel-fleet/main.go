// Command otel-fleet runs the otel-fleet control plane: the REST API (:8080),
...
import (
	...
	"github.com/sag-solutions/otel-fleet/internal/alerting"
	"github.com/sag-solutions/otel-fleet/internal/api"
	...
	"github.com/sag-solutions/otel-fleet/internal/tlsconf"
...
func main() {
	...
	if err := run(log); err != nil {
		log.Error("otel-fleet exited with error", "err", err)
		os.Exit(1)
	}
}
