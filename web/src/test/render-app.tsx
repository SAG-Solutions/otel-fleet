...
export const testProviders: AuthProviderConfig[] = [
  {
    ...
    enabled: true,
    source: 'database',
    redirectUri: 'https://otel-fleet.example.com/auth/google/callback',
    createdAt: '2026-07-01T09:00:00Z',
  },
  {
    ...
    clientId: 'otel-fleet-console',
    issuer: 'https://login.corp.example.com',
    enabled: true,
    source: 'environment',
    redirectUri: 'https://otel-fleet.example.com/auth/corp/callback',
    createdAt: '2026-07-01T09:00:00Z',
  },
  {
    ...
    idpCertificate: null,
    acsUrl: 'https://otel-fleet.example.com/auth/okta-saml/acs',
    spEntityId: 'https://otel-fleet.example.com/auth/okta-saml/metadata',
    createdAt: '2026-07-02T09:00:00Z',
  },
]
...
export const testWebhooks: Webhook[] = [
  {
    ...
    url: 'https://alerts.example.com/otel-fleet',
