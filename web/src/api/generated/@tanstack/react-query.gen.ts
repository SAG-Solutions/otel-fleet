...
import { activatePipelineVersion, createAlertRule, createApiKey, createApiToken, createAuthProviderConfig, createBootstrapToken, createCustomer, createMaintenanceWindow, createPipeline, createPipelineVersion, createWebhook, deleteAgent, deleteAlertRule, deleteAuthProviderConfig, deleteCustomer, deleteMaintenanceWindow, deletePipeline, deleteUser, deleteWebhook, devLogin, getAgent, getAgentConfig, getBillingSettings, getBillingStatement, getComponentCatalog, getCostStats, getCustomer, getCustomerThroughput, getMe, getPipeline, getPipelineStageStats, getPipelineVersion, getStatsOverview, getTrace, inviteUser, listAgentEvents, listAgents, listAlertRules, listApiKeys, listApiTokens, listAuditLog, listAuthProviderConfigs, listAuthProviders, listBootstrapTokens, listCustomerPipelines, listCustomers, listMaintenanceWindows, listPipelines, listRegions, listUsers, listWebhooks, logout, type Options, queryCustomerMetricsRange, queryLogs, queryMetricsRange, queryTraces, reencryptSecrets, revokeApiKey, revokeApiToken, revokeBootstrapToken, syncAgent, testAuthProviderConfig, testWebhook, updateAgent, updateAlertRule, updateAuthProviderConfig, updateBillingSettings, updateCustomer, updateUser, updateWebhook, validatePipeline } from '../sdk.gen';
