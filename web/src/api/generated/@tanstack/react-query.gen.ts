 ...
 */
export const listRegionsOptions = (options?: Options<ListRegionsData>) => queryOptions<ListRegionsResponse, ListRegionsError, ListRegionsResponse, ReturnType<typeof listRegionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 *
 * Re-renders and re-pushes the customer's current edge config to all of that customer's connected edge agents (edge config is per-customer, so all of a customer's agents run the same config). Use this to recover an agent stuck out of sync, or to re-apply after a failed config. The push is asynchronous (handled by the OpAMP tier); offline agents pick it up on reconnect. Not applicable to gateway-class agents.
 */
export const syncAgentMutation = (options?: Partial<Options<SyncAgentData>>): UseMutationOptions<SyncAgentResponse, SyncAgentError, Options<SyncAgentData>> => {
    const mutationOptions: UseMutationOptions<SyncAgentResponse, SyncAgentError, Options<SyncAgentData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await syncAgent({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const queryMetricsRangeQueryKey = (options: Options<QueryMetricsRangeData>) => createQueryKey('queryMetricsRange', options);

/**
 * Proxy a range PromQL query to VictoriaMetrics (admin only)
 *
 * Runs an instant-vector PromQL query over [start,end] at step against VictoriaMetrics and returns the matrix. Admin-only — it can read every metric, including per-tenant self-telemetry. Powers the infrastructure metrics view over the cluster-monitoring bundle.
 *
 */
export const queryMetricsRangeOptions = (options: Options<QueryMetricsRangeData>) => queryOptions<QueryMetricsRangeResponse, QueryMetricsRangeError, QueryMetricsRangeResponse, ReturnType<typeof queryMetricsRangeQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await queryMetricsRange({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
 ...
 *
 */
export const queryMetricsRangeInfiniteOptions = (options: Options<QueryMetricsRangeData>) => {
    const opts = infiniteQueryOptions<QueryMetricsRangeResponse, QueryMetricsRangeError, InfiniteData<QueryMetricsRangeResponse>, QueryKey<Options<QueryMetricsRangeData>>, string | Pick<QueryKey<Options<QueryMetricsRangeData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<QueryMetricsRangeData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    start: pageParam
                }
            };
        ...
        queryKey: queryMetricsRangeInfiniteQueryKey(options)
    });
    return opts as Omit<typeof opts, 'initialData'>;
};

export const getBillingStatementQueryKey = (options: Options<GetBillingStatementData>) => createQueryKey('getBillingStatement', options);

/**
 * Priced monthly usage statement per customer (admin only)
 */
export const getBillingStatementOptions = (options: Options<GetBillingStatementData>) => queryOptions<GetBillingStatementResponse, GetBillingStatementError, GetBillingStatementResponse, ReturnType<typeof getBillingStatementQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getBillingStatement({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getBillingStatementQueryKey(options)
});

export const getBillingSettingsQueryKey = (options?: Options<GetBillingSettingsData>) => createQueryKey('getBillingSettings', options);

/**
 * Get the metered-billing price list (admin only)
 */
export const getBillingSettingsOptions = (options?: Options<GetBillingSettingsData>) => queryOptions<GetBillingSettingsResponse, GetBillingSettingsError, GetBillingSettingsResponse, ReturnType<typeof getBillingSettingsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getBillingSettingsQueryKey(options)
});

/**
 * Update the metered-billing price list (admin only)
 */
export const updateBillingSettingsMutation = (options?: Partial<Options<UpdateBillingSettingsData>>): UseMutationOptions<UpdateBillingSettingsResponse, UpdateBillingSettingsError, Options<UpdateBillingSettingsData>> => {
    const mutationOptions: UseMutationOptions<UpdateBillingSettingsResponse, UpdateBillingSettingsError, Options<UpdateBillingSettingsData>> = {
        mutationFn: async (fnOptions) => {
...
export const listBillingOverridesQueryKey = (options?: Options<ListBillingOverridesData>) => createQueryKey('listBillingOverrides', options);

/**
 * List per-customer billing price overrides (admin only)
 */
export const listBillingOverridesOptions = (options?: Options<ListBillingOverridesData>) => queryOptions<ListBillingOverridesResponse, ListBillingOverridesError, ListBillingOverridesResponse, ReturnType<typeof listBillingOverridesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listBillingOverrides({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listBillingOverridesQueryKey(options)
});

/**
 * Remove a customer's price override, reverting to global pricing (admin only)
 */
export const deleteBillingOverrideMutation = (options?: Partial<Options<DeleteBillingOverrideData>>): UseMutationOptions<DeleteBillingOverrideResponse, DeleteBillingOverrideError, Options<DeleteBillingOverrideData>> => {
    const mutationOptions: UseMutationOptions<DeleteBillingOverrideResponse, DeleteBillingOverrideError, Options<DeleteBillingOverrideData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteBillingOverride({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 *
 * Upserts a per-customer price override. A null (or omitted) price inherits the global rate for that dimension; at least one price must be provided.
 */
export const setBillingOverrideMutation = (options?: Partial<Options<SetBillingOverrideData>>): UseMutationOptions<SetBillingOverrideResponse, SetBillingOverrideError, Options<SetBillingOverrideData>> => {
    const mutationOptions: UseMutationOptions<SetBillingOverrideResponse, SetBillingOverrideError, Options<SetBillingOverrideData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setBillingOverride({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 *
 * Rewrites every discrete stored secret (SSO client secrets, webhook signing secrets) that is still sealed under an old master key so it uses the current primary key. Idempotent: secrets already under the primary key are skipped. Run this after deploying a new OTEL_FLEET_MASTER_KEY with the old key(s) in OTEL_FLEET_MASTER_KEY_SECONDARY, then drop the secondary. Pipeline exporter credentials re-key when their pipeline is next saved.
 *
 */
export const reencryptSecretsMutation = (options?: Partial<Options<ReencryptSecretsData>>): UseMutationOptions<ReencryptSecretsResponse, ReencryptSecretsError, Options<ReencryptSecretsData>> => {
    const mutationOptions: UseMutationOptions<ReencryptSecretsResponse, ReencryptSecretsError, Options<ReencryptSecretsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await reencryptSecrets({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const listAlertRulesOptions = (options?: Options<ListAlertRulesData>) => queryOptions<ListAlertRulesResponse, ListAlertRulesError, ListAlertRulesResponse, ReturnType<typeof listAlertRulesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const createAlertRuleMutation = (options?: Partial<Options<CreateAlertRuleData>>): UseMutationOptions<CreateAlertRuleResponse, CreateAlertRuleError, Options<CreateAlertRuleData>> => {
    const mutationOptions: UseMutationOptions<CreateAlertRuleResponse, CreateAlertRuleError, Options<CreateAlertRuleData>> = {
        mutationFn: async (fnOptions) => {
...
export const listMaintenanceWindowsQueryKey = (options?: Options<ListMaintenanceWindowsData>) => createQueryKey('listMaintenanceWindows', options);

/**
 * Alert maintenance windows (admin only)
 */
export const listMaintenanceWindowsOptions = (options?: Options<ListMaintenanceWindowsData>) => queryOptions<ListMaintenanceWindowsResponse, ListMaintenanceWindowsError, ListMaintenanceWindowsResponse, ReturnType<typeof listMaintenanceWindowsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listMaintenanceWindows({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listMaintenanceWindowsQueryKey(options)
});

/**
 * Create an alert maintenance window (silences all firing while active)
 */
export const createMaintenanceWindowMutation = (options?: Partial<Options<CreateMaintenanceWindowData>>): UseMutationOptions<CreateMaintenanceWindowResponse, CreateMaintenanceWindowError, Options<CreateMaintenanceWindowData>> => {
    const mutationOptions: UseMutationOptions<CreateMaintenanceWindowResponse, CreateMaintenanceWindowError, Options<CreateMaintenanceWindowData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createMaintenanceWindow({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const deleteMaintenanceWindowMutation = (options?: Partial<Options<DeleteMaintenanceWindowData>>): UseMutationOptions<DeleteMaintenanceWindowResponse, DeleteMaintenanceWindowError, Options<DeleteMaintenanceWindowData>> => {
    const mutationOptions: UseMutationOptions<DeleteMaintenanceWindowResponse, DeleteMaintenanceWindowError, Options<DeleteMaintenanceWindowData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteMaintenanceWindow({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const deleteAlertRuleMutation = (options?: Partial<Options<DeleteAlertRuleData>>): UseMutationOptions<DeleteAlertRuleResponse, DeleteAlertRuleError, Options<DeleteAlertRuleData>> => {
    const mutationOptions: UseMutationOptions<DeleteAlertRuleResponse, DeleteAlertRuleError, Options<DeleteAlertRuleData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const updateAlertRuleMutation = (options?: Partial<Options<UpdateAlertRuleData>>): UseMutationOptions<UpdateAlertRuleResponse, UpdateAlertRuleError, Options<UpdateAlertRuleData>> => {
    const mutationOptions: UseMutationOptions<UpdateAlertRuleResponse, UpdateAlertRuleError, Options<UpdateAlertRuleData>> = {
        mutationFn: async (fnOptions) => {
...
export const queryLogsInfiniteOptions = (options: Options<QueryLogsData>) => {
    const opts = infiniteQueryOptions<QueryLogsResponse, QueryLogsError, InfiniteData<QueryLogsResponse>, QueryKey<Options<QueryLogsData>>, string | Pick<QueryKey<Options<QueryLogsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const queryTracesInfiniteOptions = (options: Options<QueryTracesData>) => {
    const opts = infiniteQueryOptions<QueryTracesResponse, QueryTracesError, InfiniteData<QueryTracesResponse>, QueryKey<Options<QueryTracesData>>, string | Pick<QueryKey<Options<QueryTracesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
